<section class="min-vh-100 d-flex align-items-center py-5" style="background: url('<?= $baseUrl ?>/assets/images/city-bg.png') no-repeat bottom center; background-size: cover;">
    <div class="container">
                    ...
                    <div class="row g-0" style="min-height: 480px;">
                        ...
                        <div class="col-md-5 bg-primary-blue d-flex flex-column justify-content-center align-items-center text-white p-5 text-center">
                            ...
                            <a href="../home/index.php">
                                <img src="<?= $baseUrl ?>/assets/images/logo1.png" alt="JobHub Logo" class="mb-4 rounded-circle" width="80">
                            </a>
