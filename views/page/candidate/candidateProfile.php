							...
							<div class="row g-3">
								...
								<div class="col-12 col-md-6">
									...
									<select name="gioiTinh" class="form-select py-2">
										<option value="0" <?php echo (isset($profileData['gender']) && (int)$profileData['gender'] === 0) ? 'selected' : ''; ?>>Nam</option>
										<option value="1" <?php echo (isset($profileData['gender']) && (int)$profileData['gender'] === 1) ? 'selected' : ''; ?>>Nữ</option>
									</select>
								</div>
