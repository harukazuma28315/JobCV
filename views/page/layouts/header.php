...
<a class="navbar-brand d-flex align-items-center position-relative" href="<?= $baseUrl ?>/index.php?route=home" style="width: 150px; height: 40px;">
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav mx-auto">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?= $baseUrl ?>/index.php?route=cv/create">Dịch vụ CV</a>
			</li>
		</ul>
...
<a class="navbar-brand d-flex align-items-center position-relative" href="<?= $baseUrl ?>/index.php?route=home" style="width: 150px; height: 40px;">
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav mx-auto">
			<li class="nav-item">
				<a class="nav-link" href="<?= $baseUrl ?>/index.php?route=jobs/list"></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?= $baseUrl ?>/index.php?route=cv/create"></a>
			</li>
		</ul>
		<div class="d-flex gap-2 align-items-center">
			<?php if ($isLoggedIn): ?>
