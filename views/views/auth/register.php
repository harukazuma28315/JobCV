            ...
            <div class="col-lg-10 col-xl-9">
                <div class="card border-0 shadow-lg overflow-hidden">
                    <div class="row g-0">
                        ...
                        <!-- Cột bên trái: Điều hướng chọn Luồng đăng ký -->
                        <div class="col-md-5 bg-primary-blue text-white p-5 d-flex flex-column justify-content-center align-items-center text-center">
                        ...
                        <!-- Cột bên phải: Form nhập dữ liệu tương ứng -->
                        <div class="col-md-7 bg-white p-5">
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="candidate-form" role="tabpanel">
                                    ...
                                    <form action="index.php?url=auth/doRegisterCandidate" method="POST">
                                        <div class="mb-3">
                                ...
                                <div class="tab-pane fade" id="employer-form" role="tabpanel">
                                    ...
                                    <form action="index.php?url=auth/doRegisterEmployer" method="POST">
                                        <div class="mb-3">
